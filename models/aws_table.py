...
class ObservationAWS(Base):
    __tablename__ = "observations_aws"
    ...
    station: Mapped["Station"] = relationship(back_populates="aws_observations")

    __table_args__ = (
        UniqueConstraint("id_station", "observed_at", name="uq_observations_aws_station_time"),
        Index("idx_observations_aws_station_time", "id_station", "observed_at"),
        Index("idx_observations_aws_observed_at", "observed_at"),
    )